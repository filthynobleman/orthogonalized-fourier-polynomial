...
%% Parameters
SrcFile = 'Meshes/TOSCA/centaur2.off';
TrgFile = 'Meshes/TOSCA/centaur4.off';
KSrc = 12;
KTrg = 15;
...
FontSize = 24;
PlotTitles = true;
CM = utils.cmaps.bwr;% utils.cmaps.blend([1 1 1; 0.8 0 0]);
...
subplot(2, 4, 1);
utils.plot_scalar_map(Src, f, CM, true);
if PlotTitles
    title('Source', ...
          'Interpreter', 'LaTeX', ...
          'FontSize', FontSize);
...
subplot(2, 4, 2);
utils.plot_scalar_map(Trg, f, CM, true);
if PlotTitles
    title('Ground Truth', ...
          'Interpreter', 'LaTeX', ...
          'FontSize', FontSize);
...
subplot(2, 4, 3);
utils.plot_scalar_map(Trg, FTran, CM, true);
if PlotTitles
    TitleString = {"$NK$ Eigs";
